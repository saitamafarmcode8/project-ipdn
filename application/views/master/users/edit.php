...
<div class="row">
	<div class="col-sm-3">
		...
		<div class="card">
			<div class="card-header text-center text-truncate">
				<img src="<?= base_url('embed/users/'.$row['foto']); ?>" alt="AN" width="150" class="rounded-circle">
			</div>
			<div class="card-body">
				<div class="card-block text-center">
					<h4 class="card-title"><?= $row['nm_lengkap']; ?></h4>
	...
	<div class="col-sm-6">
		<div class="card">
			...
			<div class="card-body">
				<div class="px-3">
					<form class="form" method="POST" action="<?= site_url('proses_perbarui_profile'); ?>">
						<div class="form-body">
							<div class="row">
								<input type="hidden" class="form-control" name="idtag" value="<?= $row['nikuser']; ?>">
								<div class="form-group col-6 mb-2">
									<label>Nama Lengkap</label>
									<input type="text" value="<?= $row['nm_lengkap']; ?>" class="form-control" name="nmlengkap" autofocus="autofocus" autocomplete="off">
								</div>
								<div class="form-group col-6 mb-2">
									<label>Username</label>
									<input type="text" class="form-control" value="<?= $row['username']; ?>" name="uname" autofocus="autofocus" autocomplete="off">
								</div>
								<div class="form-group col-6 mb-2">
									<label>E-mail</label>
									<input type="text" class="form-control" value="<?= $row['email']; ?>" name="email" autofocus="autofocus" autocomplete="off">
								</div>
								<div class="form-group col-6 mb-2">
									<label>Nik User</label>
									<input type="text" class="form-control" value="<?= $row['nikuser']; ?>" name="nik" autofocus="autofocus" autocomplete="off">
								</div>
							</div>
						</div>
		...
		<div class="card">
			...
			<div class="card-body">
				<div class="px-3">
					<form class="form" method="POST" action="<?= base_url('news_profile_changepass_data_xml'); ?>">
						<input type="hidden" name="idpass" class="form-control" value="<?= $row['nikuser']; ?>">
						<div class="form-body">
							<div class="row">
								<div class="form-group col-6 mb-2">
